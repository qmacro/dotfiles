...
_G.packer_plugins = {
  ...
  ["goyo.vim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/goyo.vim",
    url = "https://github.com/junegunn/goyo.vim"
  },
  ["jq.vim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/jq.vim",
    url = "https://github.com/vito-c/jq.vim"
  },
  ["limelight.vim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/limelight.vim",
  ...
  ["onedark.vim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/onedark.vim",
